...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppCarEditorComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CarEditorComponent", function () {
    ...
    var _rest_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./rest-api.service */
    ...
    function CarEditorComponent_mat_error_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CarEditorComponent_mat_error_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-error");
    ...
    function CarEditorComponent_mat_option_18_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CarEditorComponent_mat_error_19_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "mat-error");
    ...
    var carModelValidator = function carModelValidator(control) {
      if (!control.value) return {
        validator: "model is required"
      };

      if (typeof control.value == "string") {
        return {
          validator: "invalid model"
        };
      }
    ...
    var CarEditorComponent =
    /*#__PURE__*/
    function () {
      function CarEditorComponent(restApi) {
        var _this = this;

        _classCallCheck(this, CarEditorComponent);
        ...
        this.price = 0;
        this.modelList = [];
        this.modelControl.valueChanges.subscribe(function (value) {
          if (typeof value === "string") {
            var v = value.trim().toLowerCase();

            var filteredList = _this.modelList.filter(function (model) {
              return model.name.toLowerCase().startsWith(v);
            });

            if (filteredList.length == 1 && filteredList[0].name.length == v.length) {
              _this.modelControl.setValue(filteredList[0]);

              _this.showModels = [];
              return;
            }

            _this.showModels = value.length === 0 ? _this.modelList : _this.modelList.filter(function (model) {
              return model.name.toLowerCase().startsWith(v);
            });
          }
        });
      ...
      _createClass(CarEditorComponent, [{
        key: "ngOnInit",
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    promiseModels = this.restApi.getModels();
                    _context.next = 3;
                    return promiseModels;

                  case 3:
                    this.modelList = _context.sent;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    if (!(this.carNameControl.invalid || this.vinControl.invalid || this.priceControl.invalid || this.modelControl.invalid)) {
                      _context2.next = 6;
                      break;
                    }
                  ...
                  case 6:
                    ...
                    _context2.next = 14;
                    return this.restApi.addCars(this._editCar);

                  case 14:
                    this._editCar.id = _context2.sent;
                  ...
                  case 18:
                    _context2.next = 20;
                    return this.restApi.updateCars(this._editCar);
        ...
        key: "getModelTitle",
        value: function getModelTitle(value) {
        ...
        set: function set(car) {
          if (car == undefined) throw new Error('the attribute value must be a Car object');
          this._editCar = car;
    ...
    CarEditorComponent.ɵfac = function CarEditorComponent_Factory(t) {
      return new (t || CarEditorComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_rest_api_service__WEBPACK_IMPORTED_MODULE_3__["RestApi"]));
    };

    CarEditorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      type: CarEditorComponent,
      selectors: [["car-editor"]],
      hostAttrs: [2, "display", "inline-block"],
      inputs: {
        editCar: ["value", "editCar"]
      },
      outputs: {
        valueSubmited: "value-submit"
      },
      decls: 28,
      vars: 12,
      consts: [["appearance", "outline"], ["matInput", "", 3, "formControl"], ["matInput", "", 3, "minlength", "formControl"], [4, "ngIf"], ["matInput", "", 3, "formControl", "matAutocomplete"], [3, "displayWith"], ["modelListComp", "matAutocomplete"], [3, "value", 4, "ngFor", "ngForOf"], ["type", "number", "matInput", "", 3, "formControl"], ["mat-raised-button", "", "color", "primary", 2, "margin-left", "1ch", 3, "click"], [3, "value"]],
      template: function CarEditorComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CarEditorComponent_Template_button_click_26_listener($event) {
            return ctx.submitCar();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CarEditorComponent, [{
        ...
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_3__["RestApi"]
        }];
      }, {
        valueSubmited: [{
  ...
  /***/
  function srcAppCarListPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _rest_api_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./rest-api.service */
    "./src/app/rest-api.service.ts");
    /* harmony import */
    ...
    var _CarEditorComponent__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./CarEditorComponent */
    "./src/app/CarEditorComponent.ts");
    /* harmony import */
    ...
    var _c0 = ["carEditorTemplate"];

    function CarListPage_ng_template_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("value-submit", function CarListPage_ng_template_2_Template_car_editor_value_submit_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r27);

          var ctx_r26 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r26.addUpdateCar($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CarListPage_ng_template_2_Template_button_click_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r27);

          var ctx_r28 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r28.clearCar();
        });
    ...
    function CarListPage_th_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CarListPage_td_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CarListPage_td_14_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CarListPage_th_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CarListPage_td_17_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "td", 24);
    ...
    function CarListPage_td_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "td", 25);
      }
    }

    function CarListPage_th_20_mat_option_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CarListPage_th_20_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("valueChange", function CarListPage_th_20_Template_mat_select_valueChange_1_listener($event) {
          ...
          return ctx_r33.filterListCarByModels($event);
        });
    ...
    function CarListPage_td_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CarListPage_td_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "td", 32);
      }
    }

    function CarListPage_th_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "th", 26);
    ...
    function CarListPage_td_25_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "td", 24);
    ...
    function CarListPage_td_26_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "td", 25);
    ...
    function CarListPage_th_28_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "th", 26);
    ...
    function CarListPage_td_29_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CarListPage_td_29_Template_button_click_1_listener($event) {
          ...
          return ctx_r38.btnEditCar(element_r37);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CarListPage_td_29_Template_button_click_3_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r39);
          ...
          return ctx_r40.deleteCar(element_r37);
        });
    ...
    function CarListPage_tr_30_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "tr", 35);
      }
    }

    function CarListPage_tr_31_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "tr", 36);
      }
    }

    function CarListPage_tr_32_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function CarListPage(restApi, dialogSvc, route) {
      ...
      _createClass(CarListPage, [{
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return this.restApi.getModels();

                  case 2:
                    this.listModels = _context3.sent;
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    promiseCars = this.restApi.getCars();
                    _context4.next = 5;
                    return promiseCars;

                  case 5:
                    this.listCars = _context4.sent;
                    this.dataSource.data = this.listCars;
                    this.price = this.listCars.map(function (t) {
                      return t.price;
        ...
        key: "addUpdateCar",
        value: function addUpdateCar(isAdded) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0,
          /*#__PURE__*/
        ...
        key: "filterListCarByModels",
        value: function filterListCarByModels(selectedModels) {
          var filteredCars = [];
          ...
          this.listCars.forEach(function (car) {
            if (selectedModels.find(function (currentModel) {
              return currentModel.id == car.model.id;
            })) {
        ...
        key: "btnEditCar",
        value: function btnEditCar(car) {
          this.editCar = car;
          this.dialog = this.dialogSvc.open(this.carEditorTemplate);
        }
      }, {
        key: "deleteCar",
        value: function deleteCar(_deleteCar) {
          this.restApi.deleteCars(_deleteCar);
          var index = this.listCars.indexOf(_deleteCar, 0);
    ...
    CarListPage.ɵfac = function CarListPage_Factory(t) {
      return new (t || CarListPage)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_rest_api_service__WEBPACK_IMPORTED_MODULE_6__["RestApi"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_7__["MatDialog"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_8__["ActivatedRoute"]));
    };

    CarListPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      type: CarListPage,
      selectors: [["ng-component"]],
      viewQuery: function CarListPage_Query(rf, ctx) {
        if (rf & 1) {
      ...
      template: function CarListPage_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "button", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CarListPage_Template_button_click_0_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("keyup", function CarListPage_Template_input_keyup_8_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CarListPage, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
        args: [{
        ...
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_6__["RestApi"]
        }, {
  ...
  /***/
  function srcAppCarModelsPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CarModelsPage", function () {
      return CarModelsPage;
    });
    /* harmony import */
    ...
    var CarModelsPage = function CarModelsPage() {
      _classCallCheck(this, CarModelsPage);
    };

    CarModelsPage.ɵfac = function CarModelsPage_Factory(t) {
      return new (t || CarModelsPage)();
    };

    CarModelsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CarModelsPage,
      selectors: [["ng-component"]],
      decls: 2,
      vars: 0,
      template: function CarModelsPage_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CarModelsPage, [{
  ...
  /***/
  function srcAppNotFoundPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NotFoundPage, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 0,
      consts: [[2, "position", "absolute", "top", "0", "bottom", "0", "right", "0", "left", "0"], ["mode", "side", "opened", "", 1, "cars-sidenav"], ["href", "javascript:void(0)", "routerLink", "/car-list"], ["href", "javascript:void(0)", "routerLink", "/car-models"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _rest_api_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./rest-api.service */
    "./src/app/rest-api.service.ts");
    /* harmony import */
    ...
    var _CarEditorComponent__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./CarEditorComponent */
    "./src/app/CarEditorComponent.ts");
    /* harmony import */


    var _car_editor_dialog__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./car-editor-dialog */
    "./src/app/car-editor-dialog.ts");
    /* harmony import */


    var _CarListPage__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./CarListPage */
    "./src/app/CarListPage.ts");
    /* harmony import */
    ...
    var _routes__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./routes */
    "./src/app/routes.ts");
    /* harmony import */


    var _CarModelsPage__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ./CarModelsPage */
    "./src/app/CarModelsPage.ts");
    /* harmony import */


    var _NotFoundPage__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./NotFoundPage */
    "./src/app/NotFoundPage.ts");
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_20__["RouterModule"].forRoot(_routes__WEBPACK_IMPORTED_MODULE_21__["routes"], {
        useHash: true
      }), _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_9__["MatAutocompleteModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_14__["MatSidenavModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_6__["MatInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["CommonModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_10__["MatTableModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_11__["MatPaginatorModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_12__["MatSelectModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_16__["HttpClientModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_13__["MatDialogModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _CarListPage__WEBPACK_IMPORTED_MODULE_19__["CarListPage"], _CarModelsPage__WEBPACK_IMPORTED_MODULE_22__["CarModelsPage"], _CarEditorComponent__WEBPACK_IMPORTED_MODULE_17__["CarEditorComponent"], _car_editor_dialog__WEBPACK_IMPORTED_MODULE_18__["CarEditorDialog"], _NotFoundPage__WEBPACK_IMPORTED_MODULE_23__["NotFoundPage"]],
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_20__["RouterModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormFieldModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_9__["MatAutocompleteModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_14__["MatSidenavModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_6__["MatInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["CommonModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_10__["MatTableModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_11__["MatPaginatorModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_12__["MatSelectModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_16__["HttpClientModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_13__["MatDialogModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppCarEditorDialogTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CarEditorDialog", function () {
      return CarEditorDialog;
    });
    /* harmony import */
    ...
    var CarEditorDialog = function CarEditorDialog() {
      _classCallCheck(this, CarEditorDialog);
    };

    CarEditorDialog.ɵfac = function CarEditorDialog_Factory(t) {
      return new (t || CarEditorDialog)();
    };

    CarEditorDialog.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CarEditorDialog,
      selectors: [["ng-component"]],
      decls: 0,
      vars: 0,
      template: function CarEditorDialog_Template(rf, ctx) {},
      encapsulation: 2
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CarEditorDialog, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModelsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Car = function Car(name, vin, price) {
    ...
    var _models = ["Abarth", "AC", "AC Propulsion", "Acura", "A.D. Tramontana", "Aixam", "Alfa Romeo", "Almac", "Alpina", "Alpine", "Alternative Cars", "AMC", "Amuza", "Anteros", "Arash", "Ariel", "Arrinera", "ASL", "Asterio", "Aston Martin", "Audi", "BAC", "Bajaj", "Beijing Automobile Works", "Bentley", "BMW", "Bolloré", "Bolwell", "Brilliance", "Bristol", "BRM Buggy", "Brooke", "Buddy", "Bufori", "Bugatti", "Buick", "BYD", "Cadillac", "Callaway Cars", "Caterham Cars", "Caterpillar Inc.", "Changan Automobile", "Changfeng Motor", "Changhe", "Chery", "Chevrolet", "Chrysler", "Citroën", "Cizeta", "Dacia", "Daihatsu", "Datsun", "De La Chapelle", "DeLorean", "DeSoto", "Devon Motorworks", "De Tomaso", "Diardi", "Dodge", "Dongfeng", "Donkervoort", "Donto", "DS Automobiles", "Dynasti Electric Car Corp.", "Eagle", "E-Vade", "Effedi", "Egy-Tech Engineering", "Electric Raceabout", "Elfin", "Elio Motors", "Englon", "Esemka", "Etox", "Equus", "Exagon", "Faralli", "FAW", "Ferrari", "Fiat", "Fisker", "Foday", "Force", "Ford", "Ford Australia", "Ford Germany", "Foton Motor", "Fraser", "GAC Group", "Galpin", "GAZ", "Geely", "Genesis", "Gibbs", "Gillet", "Ginetta", "GMC", "Great Wall", "GTA Motor", "G Wagon", "Hafei", "Hawtai", "Hennessey", "Hindustan", "Holden", "Honda", "Hongqi", "HTT Technologies", "Hyundai", "ICML", "IFR", "Iran Khodro", "Infiniti", "Isdera", "Isuzu", "JAC", "Jaguar", "Jeep", "Jetcar", "Jonway", "JOSS", "Kaipan", "Kantanka", "Karma", "Kenworth", "Kia", "Kiira Motors Corporation", "Kish Khodro", "Koenigsegg", "Korres", "KTM", "Lada", "Lamborghini", "Lancia", "Land Rover", "Landwind", "Laraki", "LeBlanc", "Leitch", "Leopard", "Lexus", "Li-ion", "Lifan", "Lightning", "Lincoln", "Lister", "Local Motors", "Lobini", "Lotec", "Lotus Cars", "Lucra Cars", "Luxgen", "Mahindra", "Maruti Suzuki", "Maserati", "Mastretta", "Mazda", "McLaren", "Mercedes-Benz", "MG", "Micro", "Mini", "Mitsubishi", "Mitsuoka", "Morgan", "Mullen", "MyCar", "Mitsubishi", "Nissan", "Noble", "Nota", "Opel", "Orca", "Pagani", "Panoz", "Peel", "Perana", "Perodua", "Peugeot", "P.G.O.", "Polaris", "Pontiac", "Porsche", "Praga", "Proton", "Puritalia", "Qoros", "Qvale", "Radical", "Renault", "Rimac", "Rinspeed", "Roding", "Roewe", "Rolls-Royce", "Rossin-Bertin", "Rossion", "Ruf Automobile", "SAIC-GM-Wuling", "SAIPA", "Saker", "Saleen", "Samsung", "Sbarro", "SEAT", "Shanghai Maple", "SIN", "Škoda", "Smart", "Spada Vetture Sport", "Spyker Cars", "Ssangyong Motor", "SSC North America", "Subaru", "Suzuki", "Tanom", "Tata", "Tatra", "Tesla", "TD Cars", "Thai Rung", "Toyota", "Triumph", "Troller", "Tuk Tuk", "Tushek", "TVR", "UEV", "Ultima", "UMM", "Unimog", "Uri", "UAZ", "Vauxhall Motors", "Vector", "Vencer", "Venirauto", "Venturi", "VEPR", "VinFast", "Volkswagen", "Volvo", "W Motors", "Wallyscar", "Westfield", "Wheego", "Wiesmann", "Youabian Puma", "Zagato", "Zender Cars", "Zenvo", "Zolfe", "Zotye Auto", "ZX Auto"]; //export const models:CarModel[]=_models.map((model)=>({id:Number,name:model.toLowerCase()}));
  ...
  function srcAppRestApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "RestApi", function () {
      return RestApi;
    });
    /* harmony import */
    ...
    function () {
      ...
      _createClass(RestApi, [{
        key: "addCars",
        value: function addCars(newCar) {
          return this.http.post("".concat(url, "/cars"), newCar).toPromise();
        }
      }, {
        key: "updateCars",
        value: function updateCars(updateCar) {
          return this.http.put("".concat(url, "/cars/").concat(updateCar.id), updateCar).toPromise();
        }
      }, {
        key: "deleteCars",
        value: function deleteCars(deleteCar) {
          return this.http.delete("".concat(url, "/cars/").concat(deleteCar.id)).toPromise();
        }
      }, {
        key: "getCars",
        value: function getCars() {
          return this.http.get("".concat(url, "/cars")).toPromise();
        }
      }, {
        key: "getModels",
        value: function getModels() {
          return this.http.get("".concat(url, "/models")).toPromise();
        }
      }]);
    ...
    RestApi.ɵfac = function RestApi_Factory(t) {
      return new (t || RestApi)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };

    RestApi.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: RestApi,
      factory: RestApi.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RestApi, [{
  ...
  function srcAppRoutesTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _CarListPage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./CarListPage */
    "./src/app/CarListPage.ts");
    /* harmony import */


    var _CarModelsPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./CarModelsPage */
    "./src/app/CarModelsPage.ts");
    /* harmony import */


    var _NotFoundPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./NotFoundPage */
    "./src/app/NotFoundPage.ts");
    ...
    var routes = [{
      ...
      path: 'car-list',
      component: _CarListPage__WEBPACK_IMPORTED_MODULE_0__["CarListPage"]
    }, {
      path: 'car-models',
      component: _CarModelsPage__WEBPACK_IMPORTED_MODULE_1__["CarModelsPage"]
    }, {
      path: '**',
      component: _NotFoundPage__WEBPACK_IMPORTED_MODULE_2__["NotFoundPage"]
    }];
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Александр\Documents\angular-demo2\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
